"""Switch Avatary - dynamic-input switch that passes one active input through.
...
STRING, AUDIO, etc) via a wildcard AnyType.
...
class AvatarySwitch:
    DESCRIPTION = (
        "Switch Avatary - pass-through switch that lets you pick one of "
    ...
    def pick(self, SwitchState="1", **kwargs):
        ...
        if val is None:
            raise ValueError(
                "Switch Avatary: no input is connected to the active "
