...
- `Carousel Split Avatary` auto-detects vertical or horizontal carousel separators, outputs split `images` as a list so uneven panels keep their native dimensions, and provides a marked `preview`.
