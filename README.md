...
- `Carousel Split Avatary` auto-detects carousel/grid separators using solid-gutter detection with seamless seam fallback, outputs split `images` as a list so uneven panels keep their native dimensions, and provides a marked `preview`.
