...
// Best effort shared-component load. If this import fails in a given
// Comfy build/path resolver, fallback stays active and the node still renders.
(async () => {
  const candidates = [
    '../components/toggle.mjs',
    '/extensions/ComfyUI-Avatary/components/toggle.mjs',
  ];
